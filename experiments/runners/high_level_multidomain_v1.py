...
RUNNER_PATH = REPOSITORY_ROOT / "experiments/runners/high_level_multidomain_v1.py"
MANIFEST_PATH = (
    REPOSITORY_ROOT / "experiments/manifests/high-level-multidomain-v1.json"
)
...
STATE_ROOT = Path("/opt/angler/state/project-angler/high-level-multidomain-v1")
SEALED_SEED_PATH = STATE_ROOT / "sealed/seeds-v1.json"
...
def _validate_manifest_commitments(
    ...
    if set(evaluator_commitments) != required or (
        evaluator_commitments["identity"] != EVALUATION_IDENTITY
...
def _validate_final_metrics(value: Mapping[str, object]) -> dict[str, object]:
    ...
    if (
        ...
        or metrics["identity"] != EVALUATION_IDENTITY
