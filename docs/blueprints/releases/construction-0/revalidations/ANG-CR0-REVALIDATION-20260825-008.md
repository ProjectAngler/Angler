...
base_commit: 21f7474ad40b46a6dc09ebab521f54c9089fbf50
pending_manifest_sha256: BE17E687E6CA5C26E90BF5EC206D74A68A65641185015E4120294EADF3C4129E
validator_sha256: DFC15BC26592651BE01931B34FD13D27DD71865BCEBE157ABD0AB30D2704490E
...
leaf_sha256: 6670C02625F6D0E841AA4A6ECF414641336221B8FD5D934123510D34987E8B88
...
# Revalidation 008 — corrective continuity-004 packet

## State and purpose

This specification is **PENDING / NON-AUTHORIZING**. It asks one fresh independent SAFETY reviewer to decide whether Manifest v3 may make the exact six-edit transition to a pre-start authorized state for `ANG-WORK-CR0-CONTINUITY-004@1`. It grants no present permission to run the leaf, its test, the tree validator as construction, or any output writer. Packet-authoring validation is review evidence only.

Continuity-002 is immutable rejected evidence. Revalidation 008 neither edits nor retries it. The successor exists only to correct its proven projection/addendum/test/handoff defects through fresh paths and identities while preserving every failed-005, rejected continuity-002, accepted Evidence, and accepted Resources byte.
...
- Packet 007 is immutable audit-failed evidence at commit `21f7474ad40b46a6dc09ebab521f54c9089fbf50`: PENDING Manifest `7346C520E70587A4C3E5C729F67B3AE8A2109F94012991C9B57AAFC984E91B33`; baseline-003 `134A6EDF9D608C5CDED1812C9CB4A0F63AEA99ACBCF814A79CF00EDF83492D28`; gate-003 `C7FF7AD57661D7EF2303D628E6A69A0F54C3366FA163143BA7E35EBAE76479F9`; leaf-003 `D4D15CC6C725416BB5FDCB8DC6833EB913B3A4EFD8B34303672D57D6DC072BCD`; validator-007 `A580A38909D9862609F578481548F3AD268D857C2A238E1FDA6B9D227227D00B`; spec-007 `D388D741EC2B3EEBAF8CF71A593FEA27AE878A28AD3C3186A41ECEEBCB816C8D`. Gate-003's live body used stale hash `FE2E12E1E4F5536E5978C80B43A760886C19DF71D4586B63C8EEDB312B0DAC2D` while its front matter used the actual baseline-003 hash, and validator-007 did not detect the contradiction. Decision-007 and all four continuity-003 outputs remained absent; no leaf/test/output/receipt ran. Packet 007 grants no authority and cannot be changed or retried.

## Exact packet under review

| Item | Path | SHA-256/state |
|---|---|---|
| Candidate Manifest v3 | `docs/blueprints/releases/construction-0/MANIFEST.md` | `BE17E687E6CA5C26E90BF5EC206D74A68A65641185015E4120294EADF3C4129E` |
| Baseline | `docs/blueprints/releases/construction-0/baselines/ANG-BASELINE-CR0-CONTINUITY-004.json` | `8BB2AC84692DE4F4BA55E90AF3C593506CB922149260DA569B1D2AE0359D45EC` |
| Gate | `docs/blueprints/releases/construction-0/gates/ANG-GATE-CR0-CONTINUITY-004.md` | `CAEB94B1C559E9D01A7836CB7D5DE55CB7E65D473F9C23A7E3C1CD464A1B56A6` |
| Leaf | `docs/blueprints/work/slice-00/ANG-WORK-CR0-CONTINUITY-004.md` | `6670C02625F6D0E841AA4A6ECF414641336221B8FD5D934123510D34987E8B88` |
| Validator | `docs/blueprints/work/slice-00/validate-construction-release-0-v3-008.ps1` | `DFC15BC26592651BE01931B34FD13D27DD71865BCEBE157ABD0AB30D2704490E` |
| This specification | `docs/blueprints/releases/construction-0/revalidations/ANG-CR0-REVALIDATION-20260825-008.md` | reviewer computes exact hash; no self-hash claim |
| Reserved decision | `docs/blueprints/releases/construction-0/revalidations/ANG-CR0-REVALIDATION-20260825-008-decision.json` | `ABSENT` while PENDING |

Hash direction is baseline-004 -> gate-004 -> leaf-004 -> validator-008 -> PENDING Manifest-v3 -> this specification -> future decision. Manifest names this specification only by ID/path. The future decision is the sole bridge to Root's frozen transition.

## Fresh roles and disjoint writes

Revalidation reviewer role `ANG-AUTH-SAFETY-APPROVER-001`, fresh instance `ANG-REVIEW-CODEX-SAFETY-CR0-REVALIDATION-008`, session `codex-subagent:/root/flourishing_red_team`, is independent/reachable and returned fresh `ACK_ACCEPTED` for `APPROVED|REJECTED|ESCALATE`. It may later write only the decision-008 JSON. It is barred from Manifest, packet files, executor outputs, old rejection evidence, and both receipt paths.

The future executor is fresh identity `ANG-EXEC-CODEX-ROOT-CR0-CONTINUITY-004` bound to persistent task `01a03a80-bb20-7d01-acf6-f50ca4856be5`. Gate reviewer role `ANG-AUTH-SAFETY-APPROVER-001`, fresh instance `ANG-REVIEW-CODEX-SAFETY-CR0-CONTINUITY-004`, session `codex-subagent:/root/safety_change_map`, returned fresh `ACK_ACCEPTED` for `RECONCILIATION_ACCEPTED|RECONCILIATION_REJECTED|ESCALATE` and may later write only `CONTINUITY-004.md`. Validator `ANG-AUTH-VALIDATOR-001` and recorder `ANG-BP-ROOT` are separate from both reviewers and executor. No role may borrow a predecessor acknowledgement or disposition.

## Required independent checks

The reviewer must verify without construction execution:

1. Base identity is `21f7474ad40b46a6dc09ebab521f54c9089fbf50`; packet changes are only Manifest plus baseline/gate/leaf/validator/spec; decision-008 and all four fresh successor targets are absent.
2. Baseline has exactly 17 unique targets: thirteen exact present projections, fresh corrective addendum/test/handoff/receipt absent; rollback is 13 `restore_exact`, only test-004 `restore_or_remove`, and the other three fresh paths `preserve_on_failure`.
...
4. Packet-007's five immutable non-Manifest files rehash exactly, decision-007 and all four continuity-003 future paths remain absent, and Manifest preserves the exact failed candidate hash and clean commit.
5. Evidence decision is `520472287C0406793DCAECD3DBFDEB014FAC1A60C4A6E218EA4442643DC500A0` with exact leaf `5CF4A9DE5337D1C52F3D8E1CFEC6404425853808F65F31DBA6BB7284EDC53289`, gate `A883FE8799BF06390B9691F1F15F06763DAD3FB5A7210F958A2AADA7C68548F5`, baseline `F05FA1F18183D089B53CFC1EA27139775C447709D05B6C8E303DC477E3329F8F`, execution Manifest `802D152574ABD5771CF851293F9E2240039472F61DBC78472D2BF3638CE5E5D2`, test receipt `897D57E64169654F41422D70A2DA87C3E15E22A521A77437A8E80FB12B3C3E53`, effect receipt `9808AFC82EF8B77DAABF8296E11A54C267E087566BA24ABA46999747A775C893`, original handoff `017969B6E382D405EE32E73306808C82BB283A2B68E5CAC1129596439AC5C855`, and all 14/14 implementation hashes.
6. Resources receipt `D7221A84BE404A64487E79A93B5268E5E819E153B3F07E5647473F2855A24B4B` and the complete Resources leaf/gate/baseline/decision/Manifest/seven-output/handoff map rehash exactly.
7. Gate-004 contains exactly one canonical live continuity-004 baseline binding, and it is `8BB2AC84692DE4F4BA55E90AF3C593506CB922149260DA569B1D2AE0359D45EC`; validator-008 rejects the stale packet-007 pair and every competing hash for exact ID `ANG-BASELINE-CR0-CONTINUITY-004`.
8. Executor owns exactly sixteen fresh/current output paths; gate reviewer owns only fresh receipt-004; revalidation reviewer owns only decision-008; denied old paths are explicit; roles are disjoint.
9. The successor test contract has exactly 64 named positive/negative cases covering every frozen binding, 14/14 Evidence implementation identities, complete Resources map, both failure lineages, the canonical live continuity-004 baseline binding, projections, role/scope/non-equivalence, and all predeclared mutation classes.
10. The handoff contract requires authorized Manifest/leaf/gate/baseline hashes, all 17 pre-start and 16 post-write target identities, exact commands/results/64-case count/wall times, byte ceilings, metric evidence, effects, rollback, and reviewer path.
11. Normal Evidence, Resources, and Human-Flourishing gates remain `NOT_RUN`; Slice 00 and M0 remain `NOT_PASSED`; continuity acceptance cannot activate SAFETY or any other leaf.
...
Only the bound revalidation reviewer may create decision-008. It must include:

- `revalidation_id`: `ANG-CR0-REVALIDATION-20260825-008`;
- `disposition`: exactly `APPROVED`, `REJECTED`, or `ESCALATE`;
- exact reviewer role/instance/session/`ACK_ACCEPTED`;
- bindings for PENDING Manifest `BE17E687E6CA5C26E90BF5EC206D74A68A65641185015E4120294EADF3C4129E`, this specification's computed hash, validator `DFC15BC26592651BE01931B34FD13D27DD71865BCEBE157ABD0AB30D2704490E`, baseline `8BB2AC84692DE4F4BA55E90AF3C593506CB922149260DA569B1D2AE0359D45EC`, gate `CAEB94B1C559E9D01A7836CB7D5DE55CB7E65D473F9C23A7E3C1CD464A1B56A6`, leaf `6670C02625F6D0E841AA4A6ECF414641336221B8FD5D934123510D34987E8B88`, and base commit;
...
5. `pending_manifest_sha256: ABSENT_UNTIL_AUTHORIZED` -> `BE17E687E6CA5C26E90BF5EC206D74A68A65641185015E4120294EADF3C4129E`.
6. Replace the exact PENDING phase line with:

```text
> **AUTHORIZED ONLY FOR `ANG-WORK-CR0-CONTINUITY-004@1`.** Revalidation 008 is independently `APPROVED`; authority exists only after this validator returns AUTHORIZED PASS.
```
...
Stop on any undeclared difference, hash drift, missing negative mutation, role collision, old-path reuse, ceiling ambiguity, competing continuity-004 baseline binding, or broadened claim. Preserve fresh corrective-004/handoff-004/receipt-004 on any future failure, preserve all rejected continuity-002 and audit-failed packet-007 evidence byte-exact, restore thirteen projections individually, and restore/remove only test-004. Never broadly delete/restore or extract the archive.
