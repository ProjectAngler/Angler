...
gate: ANG-GATE-CR0-CONTINUITY-001@1
gate_sha256: 85DAEB5E3FE72FE37EF40A141FB7DA8B2A133590C6520B2BC1BC55D0C94E20AC
baseline: ANG-BASELINE-CR0-CONTINUITY-001
rollback_ref: ANG-BASELINE-CR0-CONTINUITY-001@sha256:EA997CD8B78817514A906BECC85491D4ACF74BB650D0324006C6C806D7A5A9F7
...
- `docs/blueprints/releases/construction-0/baselines/ANG-BASELINE-CR0-CONTINUITY-001.json`
- `docs/blueprints/releases/construction-0/gates/ANG-GATE-CR0-CONTINUITY-001.md`
- `docs/blueprints/releases/construction-0/revalidations/ANG-CR0-REVALIDATION-20260825-005.md`
- `docs/blueprints/work/slice-00/validate-construction-release-0-v3.ps1`
...
Executor `ANG-EXEC-CODEX-ROOT-CR0-CONTINUITY-001`, persistent task `01a03a80-bb20-7d01-acf6-f50ca4856be5`, may author only these sixteen paths with Codex `apply_patch`:
...
The executor is explicitly denied `docs/blueprints/releases/construction-0/branch-receipts/CONTINUITY.md`. Only reviewer instance `ANG-REVIEW-CODEX-SAFETY-CR0-CONTINUITY-001`, session `codex-subagent:/root/safety_change_map`, may create that one path after the executor handoff. Reviewer and recorder cannot edit executor outputs; root recorder cannot alter the receipt disposition.
